...
-- Hands on 5
SET SQL_SAFE_UPDATES = 0;  -- temporary disable safe update
SET SQL_SAFE_UPDATES = 1;  -- temporary enable safe 
DELETE FROM country;
...
SELECT COUNT(*) FROM country;  -- it should output: 249
...
-- FACEBOOK (FB)
-- ===========================
('FB','2019-09-01',181.20,183.40,13500000),
('FB','2019-09-02',183.40,184.10,14000000),
('FB','2019-09-03',184.10,182.90,14500000),
('FB','2019-09-04',182.90,186.20,13800000),
('FB','2019-09-05',186.20,188.00,15000000),
('FB','2019-09-06',188.00,187.30,15200000),
('FB','2019-09-07',187.30,189.20,15500000),
('FB','2019-09-08',189.20,190.00,16000000),
('FB','2019-09-09',190.00,191.50,14800000),
('FB','2019-09-10',191.50,193.00,17000000),
('FB','2019-09-11',193.00,194.20,18000000),
('FB','2019-09-12',194.20,195.50,95000000),
('FB','2019-09-13',195.50,196.80,22000000),
('FB','2019-09-14',196.80,198.10,92000000),
('FB','2019-09-15',198.10,199.00,91000000),

-- ===========================
-- GOOGLE (GOOGL)
-- ===========================
('GOOGL','2019-04-20',1220.00,1230.00,1200000),
('GOOGL','2019-04-21',1230.00,1240.00,1250000),
('GOOGL','2019-04-22',1240.00,1255.00,1300000),
('GOOGL','2019-04-23',1255.00,1265.00,1280000),
('GOOGL','2019-04-24',1265.00,1275.00,1400000),
('GOOGL','2019-04-25',1275.00,1280.00,1450000),
('GOOGL','2019-04-26',1280.00,1295.00,1500000),
('GOOGL','2019-04-27',1295.00,1305.00,1480000),
('GOOGL','2019-04-28',1305.00,1310.00,1600000),
('GOOGL','2019-04-29',1310.00,1325.00,1650000),
('GOOGL','2019-04-30',1325.00,1330.00,1700000),
('GOOGL','2019-05-01',1330.00,1345.00,1680000),
('GOOGL','2019-05-02',1345.00,1355.00,1720000),
('GOOGL','2019-05-03',1355.00,1360.00,1800000),
('GOOGL','2019-05-04',1360.00,1375.00,1850000),

-- ===========================
-- NETFLIX (NFLX)
-- ===========================
('NFLX','2019-06-01',320.00,315.00,7200000),
('NFLX','2019-06-02',315.00,310.00,7000000),
('NFLX','2019-06-03',310.00,305.00,7100000),
('NFLX','2019-06-04',305.00,295.00,7600000),
('NFLX','2019-06-05',295.00,285.00,8100000),
('NFLX','2019-06-06',285.00,275.00,8500000),
('NFLX','2019-06-07',275.00,280.00,8300000),
('NFLX','2019-06-08',280.00,290.00,8000000),
('NFLX','2019-06-09',290.00,300.00,7900000),
('NFLX','2019-06-10',300.00,310.00,7800000),
('NFLX','2019-06-11',310.00,320.00,7700000),
('NFLX','2019-06-12',320.00,325.00,7600000),
('NFLX','2019-06-13',325.00,330.00,7500000),
('NFLX','2019-06-14',330.00,335.00,7400000),
('NFLX','2019-06-15',335.00,340.00,7300000);
